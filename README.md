...
9. <span style="color:#785EF0">Wrong Template + Wrong Role + Partially Matched Filler.</span> Same as 8. above, but with an added Alter Span transformation applied first to account for partial matching.
